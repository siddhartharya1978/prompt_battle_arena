...
-- Drop all existing policies (RLS will be re-enabled)
...
-- =====================================================
-- PHASE 9: DEMO DATA FOR TESTING (OPTIONAL)
-- =====================================================

-- Note: Demo users will be created through the app's signup process
-- siddhartharya.ai@gmail.com will automatically get admin role via trigger
