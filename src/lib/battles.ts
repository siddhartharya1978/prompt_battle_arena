...
export const createBattle = async (battleData: BattleData): Promise<Battle> => {
  ...
  if (demoSession) {
    ...
    // Simulate battle creation delay
    ...
    return {
      ...
      responses: [
        {
          id: `response_${Date.now()}_1`,
          battleId: mockBattleId,
          modelId: battleData.models[0],
          response: `This is a mock response from ${battleData.models[0]} for the prompt: "${battleData.prompt.substring(0, 50)}...". In a real deployment, this would be generated by the actual AI model with sophisticated reasoning and creativity.`,
        ...
        {
          id: `response_${Date.now()}_2`,
          battleId: mockBattleId,
          modelId: battleData.models[1],
          response: `This is a mock response from ${battleData.models[1]} for the prompt: "${battleData.prompt.substring(0, 50)}...". This model would provide a different perspective and approach to answering your question with unique insights.`,
          latency: Math.floor(Math.random() * 1000) + 500,
          tokens: Math.floor(Math.random() * 200) + 50,
          cost: Math.random() * 0.5 + 0.05,
          createdAt: new Date().toISOString()
      ...
      scores: {
        [battleData.models[0]]: {
          ...
          reasoning: Math.random() * 3 + 7,
          structure: Math.random() * 3 + 7,
          creativity: Math.random() * 3 + 7,
          overall: Math.random() * 2 + 8,
          notes: `Mock scoring for ${battleData.models[0]}. In production, this would be generated by our AI judge with detailed analysis.`
        },
        [battleData.models[1]]: {
          accuracy: Math.random() * 3 + 7,
          reasoning: Math.random() * 3 + 7,
          ...
          creativity: Math.random() * 3 + 7,
          overall: Math.random() * 2 + 8,
          notes: `Mock scoring for ${battleData.models[1]}. In production, this would be generated by our AI judge with detailed analysis.`
        }
      }
    };
  }
